...
#ifndef ROTORS_GAZEBO_PLUGINS_GAZEBO_EXTERNAL_WRENCH_PLUGIN_H
#define ROTORS_GAZEBO_PLUGINS_GAZEBO_EXTERNAL_WRENCH_PLUGIN_H
...
class GazeboExternalWrenchPlugin : public ModelPlugin {
 public:
  GazeboExternalWrenchPlugin()
      : ModelPlugin(),
...
#endif // ROTORS_GAZEBO_PLUGINS_GAZEBO_EXTERNAL_WRENCH_PLUGIN_H
