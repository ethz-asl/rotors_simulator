...
#ifndef _GAZEBO_LIDAR_CE30D_PLUGIN_HH_
#define _GAZEBO_LIDAR_CE30D_PLUGIN_HH_
...
class GAZEBO_VISIBLE GazeboLidarCE30DPlugin : public SensorPlugin
{
  /// \brief Constructor
public:
  GazeboLidarCE30DPlugin();

  /// \brief Destructor
public:
  virtual ~GazeboLidarCE30DPlugin();
