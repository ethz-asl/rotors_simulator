#include "_coder_p_ee_fun_info.h"
...
const mxArray *emlrtMexFcnResolvedFunctionsInfo()
{
  ...
  emlrtAssign(&nameCaptureInfo, emlrtCreateStructMatrix(12, 1, 0, NULL));
...
static void info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/home/comaris/Dropbox/ETH/Master_Thesis/arw_model/model/NEO2/matlab_functions/p_ee_fun.m"),
                "context", 0);
...
mxArray *emlrtMexFcnProperties()
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", mxCreateString("p_ee_fun"));
