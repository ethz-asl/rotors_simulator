...
## Generated on : Fri Nov 27 16:21:13 2015
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/librotors/G_fun -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=G_fun -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)/librotors/G_fun/G_fun.cpp $(START_DIR)/librotors/G_fun/rt_nonfinite.cpp $(START_DIR)/librotors/G_fun/rtGetNaN.cpp $(START_DIR)/librotors/G_fun/rtGetInf.cpp
...
%.c.o : $(START_DIR)/librotors/G_fun/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/librotors/G_fun/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/librotors/G_fun/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
