...
emlrtContext emlrtContextGlobal = { true, false, 131419U, NULL, "M_triu_fun",
...
void M_triu_fun_api(const mxArray *prhs[1], const mxArray *plhs[1])
{
  real_T (*A)[81];
  real_T (*in1)[8];
...
void M_triu_fun_atexit(void)
{
  ...
  M_triu_fun_xil_terminate();
}

void M_triu_fun_initialize(void)
{
  emlrtStack st = { NULL, NULL, NULL };
...
void M_triu_fun_terminate(void)
{
  emlrtStack st = { NULL, NULL, NULL };
